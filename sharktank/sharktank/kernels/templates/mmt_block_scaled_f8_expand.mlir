...
!b_tensor_type = tensor<{{n}}x{{k}}x!a_type>
...
!bs_tensor_type = tensor<{{num_blocks_n}}x{{num_blocks_k}}x!scale_type>
// expand and collapse types
!a_exp_tensor_type = tensor<{{num_blocks_m}}x{{block_size_m}}x{{num_blocks_k}}x{{block_size_k}}x!a_type>
!b_exp_tensor_type = tensor<{{num_blocks_n}}x{{block_size_n}}x{{num_blocks_k}}x{{block_size_k}}x!b_type>
...
util.func private @sharktank_mmt_block_scaled_f8_2d_{{m}}_{{n}}_{{k}}_{{a_type}}(
  ...
  %b_exp = tensor.expand_shape %b [[0, 1], [2, 3]] output_shape [%num_bl_n, {{block_size_n}}, %num_bl_k, {{block_size_k}}] : !b_tensor_type into !b_exp_tensor_type
